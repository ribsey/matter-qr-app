...
const TRANSLATIONS = {
  en: {
    ...
    "payload.valid": "Valid Matter Code",
    "payload.invalid": "Invalid Matter Code",
  ...
  nl: {
    ...
    "payload.valid": "Geldige Matter-code",
    "payload.invalid": "Ongeldige Matter-code",
  ...
  es: {
    ...
    "payload.valid": "Código Matter válido",
    "payload.invalid": "Código Matter no válido",
  ...
  de: {
    ...
    "payload.valid": "Gültiger Matter-Code",
    "payload.invalid": "Ungültiger Matter-Code",
  ...
  fr: {
    ...
    "payload.valid": "Code Matter valide",
    "payload.invalid": "Code Matter non valide",
  ...
  it: {
    ...
    "payload.valid": "Codice Matter valido",
    "payload.invalid": "Codice Matter non valido",
